...
export default function LegaWorkx({ open, onOpenChange }) {
      ...
      <DialogContent className="!max-w-2xl w-[95vw] max-h-[90vh] bg-black/95 border-primary/20 text-white p-0 overflow-hidden backdrop-blur-xl">
        <DialogHeader className="px-6 pt-6 pb-4 bg-black/40 border-b border-white/5">
          <DialogTitle className="text-3xl font-bold text-gradient-gold">
            {t.subsidiary.legaWorkxName}
          </DialogTitle>
          <DialogDescription className="text-white/40 text-base">
            {t.subsidiary.legaWorkxDetails.tagline}
          </DialogDescription>
        </DialogHeader>
        ...
        <ScrollArea className="h-[calc(90vh-140px)] max-h-[calc(90vh-140px)] px-6 pb-6 bg-noise">
          <div className="space-y-6 pr-4 pt-6">
            <p className="text-white/50 leading-relaxed text-lg">
              {t.subsidiary.legaWorkxDetails.desc}
            </p>

            <p className="text-white/50 leading-relaxed">
              {t.subsidiary.legaWorkxDetails.desc2}
            </p>
            ...
            >
                ...
                <div className="space-y-6">
                  <div className="glass-dark p-6 rounded-xl border-white/5">
                    <h3 className="text-xl font-semibold text-primary flex items-center gap-3 mb-3">
                      ...
                      {t.subsidiary.legaWorkxDetails.visionBox}
                    </h3>
                  </div>
                  ...
                  <div className="glass-dark p-6 rounded-xl border-white/5 border-l-4 border-l-primary">
                    <h4 className="font-semibold text-primary mb-2 text-lg">
                      {t.subsidiary.legaWorkxDetails.visionTitle}:
                    </h4>
                    <p className="text-white/50 italic leading-relaxed">
                      "{t.subsidiary.legaWorkxDetails.visionQuote}"
                    </p>
                  </div>

                  <div className="glass-dark p-6 rounded-xl border-white/5 border-l-4 border-l-primary">
                    <h4 className="font-semibold text-primary mb-2 text-lg">
                      {t.subsidiary.legaWorkxDetails.missionTitle}:
                    </h4>
                    <ul className="text-white/50 space-y-2">
                      <li className="flex items-center gap-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-primary"></span>{" "}
                        {t.subsidiary.legaWorkxDetails.missionItem1}
                      </li>
                      <li className="flex items-center gap-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-primary"></span>{" "}
                        {t.subsidiary.legaWorkxDetails.missionItem2}
                      </li>
                      <li className="flex items-center gap-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-primary"></span>{" "}
                        {t.subsidiary.legaWorkxDetails.missionItem3}
                      </li>
                      <li className="flex items-center gap-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-primary"></span>{" "}
                        {t.subsidiary.legaWorkxDetails.missionItem4}
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <TabsContent value="services" className="space-y-6 mt-6 pb-10">
                <div className="grid gap-4">
                  {[
                    { icon: Car, key: "service1", count: 11 },
                    { icon: Wrench, key: "service2", count: 13 },
                    { icon: Palette, key: "service3", count: 10 },
                    { icon: Brain, key: "service4", count: 7 },
                    { icon: ShoppingCart, key: "service5", count: 6 },
                    { icon: Settings, key: "service6", count: 6 },
                    { icon: Rocket, key: "service7", count: 7 },
                  ].map((service) => (
                    <div
                      key={service.key}
                    ...
                    >
                      <h3 className="text-lg font-semibold text-primary mb-3 flex items-center gap-3 group-hover:text-gradient-gold transition-all">
                        ...
                        {t.subsidiary.legaWorkxDetails[service.key]}
                      </h3>
                      <ul className="space-y-2">
                        {Array.from({ length: service.count }).map((_, i) => (
                          <li
                            key={i}
                          ...
                          >
                            ...
                            {
                              t.subsidiary.legaWorkxDetails[
                                `${service.key}Item${i + 1}`
                              ]
                            }
                          </li>
                        ))}
              ...
              <TabsContent value="why-us" className="space-y-6 mt-6 pb-10">
                <h3 className="text-2xl font-semibold text-primary mb-6">
                  {t.subsidiary.legaWorkxDetails.whyLegaWorkx}
                </h3>
                  ...
                  {[1, 2, 3, 4, 5].map((i) => (
                    ...
                    >
                      ...
                      <p className="text-gray-200 text-lg">
                        {t.subsidiary.legaWorkxDetails[`whyItem${i}`]}
                      </p>
                    </div>
                  ))}
                </div>
                ...
                <div className="bg-primary/10 p-6 rounded-xl border border-primary/20 mt-8">
                  <h4 className="font-bold text-primary mb-3 text-lg">
                    {t.subsidiary.legaWorkxDetails.contactTitle}
                  </h4>
                  <p className="text-white/50 mb-4">
                    {t.subsidiary.legaWorkxDetails.contactDesc}
                  </p>
                  <div className="text-white/50 space-y-2">
                    ...
                    <p className="flex items-center gap-2">
                      <span className="text-xl">📍</span>{" "}
                      {t.subsidiaryLayout.office}:Near Al Mutlaq Hotel King
                      Abdulaziz Rd Kingdom of Saudi Arabia
                    </p>
                  </div>
                </div>
              </TabsContent>
