...
export default function LegaDeal({ open, onOpenChange }) {
      ...
      <DialogContent className="!max-w-2xl w-[95vw] max-h-[90vh] bg-black/95 border-primary/20 text-white p-0 overflow-hidden backdrop-blur-xl">
        <DialogHeader className="px-6 pt-6 pb-4 bg-black/40 border-b border-white/5">
          <DialogTitle className="text-3xl font-bold text-gradient-gold">
            {t.subsidiary.legaDealName}
          </DialogTitle>
          <DialogDescription className="text-white/40 text-base">
            {t.subsidiary.legaDealDetails.tagline}
          </DialogDescription>
        </DialogHeader>
        ...
        <ScrollArea className="h-[calc(90vh-140px)] max-h-[calc(90vh-140px)] px-6 pb-6 bg-noise">
          <div className="space-y-6 pr-4 pt-6">
            <p className="text-white/50 leading-relaxed text-lg">
              {t.subsidiary.legaDealDetails.desc}
            </p>

            <p className="text-primary font-semibold text-xl border-l-4 border-primary pl-4">
              {t.subsidiary.legaDealDetails.subHeader}
            </p>

            <p className="text-white/50 leading-relaxed">
              {t.subsidiary.legaDealDetails.longDesc}
            </p>
            ...
            >
                ...
                <div className="space-y-6">
                  <div className="glass-dark p-6 rounded-xl border-white/5">
                    <h3 className="text-xl font-semibold text-primary flex items-center gap-3 mb-3">
                      ...
                      {t.subsidiary.legaDealDetails.coreServices}
                    </h3>
                    <p className="text-white/50 leading-relaxed">
                      {t.subsidiary.legaDealDetails.coreServicesDesc}
                    </p>
                  </div>
                </div>
              </TabsContent>
                ...
                <div className="grid gap-4">
                  <div className="glass-dark p-6 rounded-xl border-white/5 hover:border-primary/30 transition-colors group">
                    <h3 className="text-lg font-semibold text-primary mb-3 flex items-center gap-3 group-hover:text-gradient-gold transition-all">
                      ...
                      {t.subsidiary.legaDealDetails.service1}
                    </h3>
                    <p className="text-white/50 mb-3">
                      {t.subsidiary.legaDealDetails.service1Desc}
                    </p>
                  </div>
                  ...
                  <div className="glass-dark p-6 rounded-xl border-white/5 hover:border-primary/30 transition-colors group">
                    <h3 className="text-lg font-semibold text-primary mb-3 flex items-center gap-3 group-hover:text-gradient-gold transition-all">
                      ...
                      {t.subsidiary.legaDealDetails.service2}
                    </h3>
                    <p className="text-white/50 mb-4">
                      {t.subsidiary.legaDealDetails.service2Desc}
                    </p>
                  </div>
                  ...
                  <div className="glass-dark p-6 rounded-xl border-white/5 hover:border-primary/30 transition-colors group">
                    <h3 className="text-lg font-semibold text-primary mb-3 flex items-center gap-3 group-hover:text-gradient-gold transition-all">
                      ...
                      {t.subsidiary.legaDealDetails.service3}
                    </h3>
                    <p className="text-white/50 mb-3">
                      {t.subsidiary.legaDealDetails.service3Desc}
                    </p>
                  </div>
                  ...
                  <div className="glass-dark p-6 rounded-xl border-white/5 hover:border-primary/30 transition-colors group">
                    <h3 className="text-lg font-semibold text-primary mb-3 flex items-center gap-3 group-hover:text-gradient-gold transition-all">
                      ...
                      {t.subsidiary.legaDealDetails.service4}
                    </h3>
                    <p className="text-white/50 mb-3">
                      {t.subsidiary.legaDealDetails.service4Desc}
                    </p>
                  </div>
                  ...
                  <div className="glass-dark p-6 rounded-xl border-white/5 hover:border-primary/30 transition-colors group">
                    <h3 className="text-lg font-semibold text-primary mb-3 flex items-center gap-3 group-hover:text-gradient-gold transition-all">
                      ...
                      {t.subsidiary.legaDealDetails.service5}
                    </h3>
                    <p className="text-white/50 mb-3">
                      {t.subsidiary.legaDealDetails.service5Desc}
                    </p>
                  </div>
                  ...
                  <div className="glass-dark p-6 rounded-xl border-white/5 hover:border-primary/30 transition-colors group">
                    <h3 className="text-lg font-semibold text-primary mb-3 flex items-center gap-3 group-hover:text-gradient-gold transition-all">
                      ...
                      {t.subsidiary.legaDealDetails.service6}
                    </h3>
                    <p className="text-white/50 mb-3">
                      {t.subsidiary.legaDealDetails.service6Desc}
                    </p>
                  </div>
                  ...
                  <div className="glass-dark p-6 rounded-xl border-white/5 hover:border-primary/30 transition-colors group">
                    <h3 className="text-lg font-semibold text-primary mb-3 flex items-center gap-3 group-hover:text-gradient-gold transition-all">
                      ...
                      {t.subsidiary.legaDealDetails.service7}
                    </h3>
                    <p className="text-white/50 mb-3">
                      {t.subsidiary.legaDealDetails.service7Desc}
                    </p>
                  </div>
                  ...
                  <div className="glass-dark p-6 rounded-xl border-white/5 hover:border-primary/30 transition-colors group">
                    <h3 className="text-lg font-semibold text-primary mb-3 flex items-center gap-3 group-hover:text-gradient-gold transition-all">
                      ...
                      {t.subsidiary.legaDealDetails.service8}
                    </h3>
                    <p className="text-white/50 mb-3">
                      {t.subsidiary.legaDealDetails.service8Desc}
                    </p>
                  </div>
                </div>
              </TabsContent>
              ...
              <TabsContent value="industries" className="space-y-6 mt-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {t.subsidiary.legaDealDetails.industriesList.map(
                    (industry, index) => (
                      <div
                        key={index}
              ...
              <TabsContent value="why-us" className="space-y-6 mt-6">
                <h3 className="text-2xl font-semibold text-primary mb-6">
                  {t.subsidiary.legaDealDetails.whyLegaDeal}
                </h3>
                <div className="space-y-4">
                  {t.subsidiary.legaDealDetails.whyLegaDealItems.map(
                    (point, index) => (
                      <div
                        key={index}
                ...
                <div className="glass-dark p-6 rounded-xl border-white/5 mt-8 text-center">
                  <h4 className="font-semibold text-primary mb-3 text-lg">
                    {t.subsidiary.legaDealDetails.gatewayTitle}
                  </h4>
                  <p className="text-white/50 leading-relaxed">
                    {t.subsidiary.legaDealDetails.gatewayDesc}
                  </p>
                </div>

                <div className="bg-primary/10 p-6 rounded-xl border border-primary/20 mt-8">
                  <h4 className="font-bold text-primary mb-3 text-lg">
                    {t.subsidiary.legaDealDetails.connectTitle}
                  </h4>
                  <p className="text-primary font-semibold mb-2">LEGADEAL</p>
